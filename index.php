...
<style> .main{
            ...
            margin-left: 150px;
            margin-right: 150px;
           background-color: rgb(240, 207, 97);
           border-color: rgb(125, 236, 121);
        }
        .Heading{
            margin:none;
            margin-top:10px;
            ...
            font-size: 50px;
            font-weight: bolder ;
            text-shadow: 0px 10px 10px rgb(234, 155, 155);
        }
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SAM.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9307834947</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SAM <p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Menu</a></li>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SAM</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SAM</h3> 
...
<div class="team" id="team">
	...
	<div class="main">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="https://th.bing.com/th/id/OIP.hZJHDfOyEh-mfHtpjZijTAHaHp?rs=1&pid=ImgDetMain"  width="250px">
                </div>
                <div class="rs">
                    Name : Chicken Biryani<br>
                    Rs.250/-
                </div>
                <div class="para">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="images/paneer.jpeg"  width="200px">
                </div>
                <div class="rs">
                    Name : Paneer Tikka Masala<br>
                    Rs.250/-
                </div>
                <div class="para">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="https://th.bing.com/th/id/OIP.Oy7UUlP9UhXy_3XtQztqRAHaHa?rs=1&pid=ImgDetMain"  width="200px">
                </div>
                <div class="rs">
                    Name : Egg Fried Rice<br>
                    Rs.200/-
                </div>
                <div class="para">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="https://th.bing.com/th/id/OIP.z5Z4CAZZInRQtzcmqk4UkgHaHa?rs=1&pid=ImgDetMain"  width="200px">
                </div>
                <div class="rs">
                    Name : Butter Nanns<br>
                    Rs.140/-
                </div>
                <div class="para">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="https://divaliciousrecipes.com/wp-content/uploads/2018/06/low-carb-strawberry-ice-cream-500x500.jpg"  width="200px">
                </div>
                <div class="rs">
                    Name : Strawberry Margarita Ice Cream<br>
                    Rs.150/-
                </div>
                <div class="para">
            ...
            <div class="item">
                <div class="Img1">
                    <img src="https://media.giphy.com/media/3o6wNGRv8JDCAiaw92/giphy.gif"  width="200px">
                </div>
                <div class="rs">
                    Name : Noodles<br>
                    Rs.150/-
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g6.jpg" class="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>SAM</h4>
					 		<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					...
					<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g9.jpg" class="swipebox"><img src="images/g3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>SAM</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								...
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/suhel.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/anuk.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/anu.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/shruti.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9307834947</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SAM.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Kini , Kolhapur , Maharashtra , India - 416112</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 SAM . All Rights Reserved | Design by <a href="index.php">SAM</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
